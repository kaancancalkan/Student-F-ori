		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#screenstudent-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"screenstudent-display": {
								"semanticObject": "screenstudent",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=screen.student",
									"url": sap.ui.require.toUrl("screen/student")
								}
							}
						}
					}
